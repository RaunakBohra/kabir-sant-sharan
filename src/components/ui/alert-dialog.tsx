...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-dark-900 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-dark-800 focus:outline-none focus:ring-2 focus:ring-dark-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
      className
    )}
    {...props}
  />
